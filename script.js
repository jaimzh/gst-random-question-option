document.addEventListener("DOMContentLoaded", () => {
  ...
  // Function to shuffle the options within a question
  ...
  // Function to display a question with shuffled options
  ...
  // Function to show the results after all questions are answered
  ...
  function restartQuiz() {
    ...
    shuffleArray(questions); // Shuffle questions again when restarting the quiz
    displayQuestion(questions[currentQuestionIndex]);
  }
